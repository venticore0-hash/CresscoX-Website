...
if (!process.env.OPENAI_API_KEY) {
  console.warn('Missing OPENAI_API_KEY. Add it to your .env file before using the chatbot.');
}
...
app.post('/api/chat', async (req, res) => {
  ...
  try {
    ...
    const reply = response.output_text?.trim() || 'I could not generate a response.';
